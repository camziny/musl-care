...
export default async function CareGiverSettings() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="max-w-4xl w-full bg-white p-6 border border-gray-200 rounded-md shadow-lg">
        ...
        >
          <div>
            ...
            <input
              ...
              className="border border-gray-300 bg-white text-black p-2 rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
          <div>
            ...
            <textarea
              ...
              className="border border-gray-300 bg-white text-black p-2 rounded w-full h-32 focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
          <div>
          ...
          <div>
            ...
            <SectSelect inputId="sects" selectedSect={careGiver.sect} />
          ...
          <div className="flex items-center">
            <input
              ...
              className="border border-gray-300 bg-white text-black rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <label
